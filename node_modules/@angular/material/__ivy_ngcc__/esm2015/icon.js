...
MatIconRegistry.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MatIconRegistry, factory: MatIconRegistry.ɵfac });
/** @nocollapse */
...
MatIcon.ɵfac = function MatIcon_Factory(t) { return new (t || MatIcon)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(MatIconRegistry), ɵngcc0.ɵɵinjectAttribute('aria-hidden')); };
MatIcon.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatIcon, selectors: [["mat-icon"]], hostAttrs: ["role", "img", 1, "mat-icon"], inputs: { color: "color", fontSet: "fontSet", fontIcon: "fontIcon", svgIcon: "svgIcon" }, exportAs: ["matIcon"], features: [ɵngcc0.ɵɵInheritDefinitionFeature, ɵngcc0.ɵɵNgOnChangesFeature], ngContentSelectors: _c0, decls: 1, vars: 0, template: function MatIcon_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵprojection(0);
    } }, styles: [".mat-icon{background-repeat:no-repeat;display:inline-block;fill:currentColor;height:24px;width:24px}"], encapsulation: 2, changeDetection: 0 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MatIcon, [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: MatIconRegistry }, { type: undefined, decorators: [{
                type: Attribute,
                args: ['aria-hidden']
            }] }]; }, { fontSet: [{
            type: Input
...
MatIconModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function MatIconModule_Factory(t) { return new (t || MatIconModule)(); }, providers: [ICON_REGISTRY_PROVIDER], imports: [[MatCommonModule],
        MatCommonModule] });
/** @nocollapse */
